 ...
 */
final class Version20220331214441 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE finance2 CHANGE dons dons VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE evenement evenement VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE commande commande VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE somme somme VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date date VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
