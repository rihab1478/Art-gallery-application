 ...
 */
final class Version20220326210216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CE606404ED766068 ON reclamation');
        $this->addSql('ALTER TABLE reclamation DROP username_id, CHANGE dater dater VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD username_id INT NOT NULL, CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE msg msg VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE dater dater DATE NOT NULL');
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE606404ED766068 FOREIGN KEY (username_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_CE606404ED766068 ON reclamation (username_id)');
