 ...
 */
final class Version20220331143523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE finance2 (id INT AUTO_INCREMENT NOT NULL, dons INT NOT NULL, evenement INT NOT NULL, commande INT NOT NULL, somme INT NOT NULL, date VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE finance CHANGE date date DATE NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE finance2');
        ...
        $this->addSql('ALTER TABLE finance CHANGE date date VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color1 color1 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color2 color2 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color3 color3 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`');
