 ...
 */
final class Version20220331140701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE finance CHANGE date date VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE finance CHANGE date date DATE NOT NULL, CHANGE color1 color1 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color2 color2 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color3 color3 VARCHAR(7) NOT NULL COLLATE `utf8mb4_unicode_ci`');
