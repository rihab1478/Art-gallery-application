 ...
 */
final class Version20220331161411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE finance2 CHANGE dons dons VARCHAR(255) NOT NULL, CHANGE evenement evenement VARCHAR(255) NOT NULL, CHANGE commande commande VARCHAR(255) NOT NULL, CHANGE somme somme VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE finance2 CHANGE dons dons INT NOT NULL, CHANGE evenement evenement INT NOT NULL, CHANGE commande commande INT NOT NULL, CHANGE somme somme INT NOT NULL, CHANGE date date VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
